function activarModal() {
  ...
  btn.addEventListener("click", async () => {
    ...
    const nombreAnfitrion =
        document.getElementById("nombreAnfitrion");
...
anfitrionSelect.addEventListener(
    "change",
    () => {
        const opcionSeleccionada =
            anfitrionSelect.options[
                anfitrionSelect.selectedIndex
            ];

        nombreAnfitrion.value =
                ...
                async () => {
                    try {
                        ...
                        if (visitantes.length === 0) {
                            ...
                            resultadosVisitantes.style.display = "block";
    ...
    const nombreAnfitrionSeleccionado =
    ...
    const datos = {
        ...
        anfitrion: nombreAnfitrionSeleccionado,
